...
# Setup logger
logger = setup_logger("iesa_wisdom_mining")
logger.info("IESA Wisdom Mining page loaded")
...
if selected == "Dashboard":
    logger.info("User navigated to Dashboard page from Wisdom Mining")
    os.system("streamlit run iesa_dashboard.py")

elif selected == "Data Planner":
    logger.info("User navigated to Data Planner page from Wisdom Mining")
    os.system("streamlit run iesa_data_planner.py")

elif selected == "Scenario":
    logger.info("User navigated to Scenario Analysis page from Wisdom Mining")
    os.system("streamlit run iesa_scenerio_analysis_with_k_means.py")

elif selected == "Prediction":
    logger.info("User navigated to Prediction Engine page from Wisdom Mining")
    os.system("streamlit run iesa_prediction_engine.py")

elif selected == "IESA Assistant":
    logger.info("User navigated to IESA Assistant page from Wisdom Mining")
