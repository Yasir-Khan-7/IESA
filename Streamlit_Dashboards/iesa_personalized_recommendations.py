...
if selected == "Data Planner":
    logger.info("User navigated to Data Planner page from Personalized Recommendations")
    os.system("streamlit run iesa_data_planner.py")

elif selected == "Dashboard":
    logger.info("User navigated to Dashboard page from Personalized Recommendations")
    os.system("streamlit run iesa_dashboard.py")
elif selected == "Scenario":
    logger.info("User navigated to Scenario Analysis page from Personalized Recommendations")
    os.system("streamlit run iesa_scenerio_analysis_with_k_means.py")

elif selected == "Prediction":
    logger.info("User navigated to Prediction Engine page from Personalized Recommendations")
    os.system("streamlit run iesa_prediction_engine.py")

elif selected == "Wisdom Mining":
    logger.info("User navigated to Wisdom Mining page from Personalized Recommendations")
...
api_keys = []  # API key removed for security
